...
import com.example.library_management.infrastructure.jooq.generated.tables.Author.AuthorPath;
...
public class BookAuthor extends TableImpl<BookAuthorRecord> {
    ...
    public List<ForeignKey<BookAuthorRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CONSTRAINT_AE, Keys.CONSTRAINT_AE6);
    }
    ...
    public BookPath book() {
        if (_book == null)
            _book = new BookPath(this, Keys.CONSTRAINT_AE, null);
    ...
    public AuthorPath author() {
        if (_author == null)
            _author = new AuthorPath(this, Keys.CONSTRAINT_AE6, null);
